...
<body>
    ...
    <div class="section">
        ...
        @php
            ...
            $houseBenefit = (float)($payslip['house_benefit_amount'] ?? 0);
            $hardshipBenefit = (float)($payslip['hardship_benefit_amount'] ?? 0);
            $otherBenefits = (float)($payslip['other_benefits_amount'] ?? 0);
            $grossEarnings = $basic + $overtime + $bonus + $allowance + $houseBenefit + $hardshipBenefit + $otherBenefits;
        ...
        <table class="salary-table">
            ...
            @if($houseBenefit > 0)
            <tr>
                <td colspan="2">House Benefit</td>
                <td class="amount">+ {{ $formatCurrency($houseBenefit) }}</td>
            </tr>
            @endif
            @if($hardshipBenefit > 0)
            <tr>
                <td colspan="2">Hardship Benefit</td>
                <td class="amount">+ {{ $formatCurrency($hardshipBenefit) }}</td>
            </tr>
            @endif
            @if($otherBenefits > 0)
            <tr>
                <td colspan="2">Other Benefits</td>
                <td class="amount">+ {{ $formatCurrency($otherBenefits) }}</td>
            </tr>
            @endif
            <tr class="subtotal">
    ...
    <div style="margin-top: 40px; page-break-inside: avoid;">
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                <td style="width: 33.33%; padding: 10px; border: none; vertical-align: top;">
                    <div style="border-top: 1px solid #333; padding-top: 8px;">
                        <span style="font-weight: bold; font-size: 10px;">PREPARED BY:</span><br>
                        <span style="font-size: 10px;">Name: _________________</span><br>
                        <span style="font-size: 10px;">Sign: _________________</span><br>
                        <span style="font-size: 10px;">Date: _________________</span>
                    </div>
                </td>
                <td style="width: 33.33%; padding: 10px; border: none; vertical-align: top;">
                    <div style="border-top: 1px solid #333; padding-top: 8px;">
                        <span style="font-weight: bold; font-size: 10px;">CHECKED BY:</span><br>
                        <span style="font-size: 10px;">Name: _________________</span><br>
                        <span style="font-size: 10px;">Sign: _________________</span><br>
                        <span style="font-size: 10px;">Date: _________________</span>
                    </div>
                ...
                <td style="width: 33.33%; padding: 10px; border: none; vertical-align: top;">
                    <div style="border-top: 1px solid #333; padding-top: 8px;">
                        <span style="font-weight: bold; font-size: 10px;">APPROVED BY:</span><br>
                        <span style="font-size: 10px;">Name: _________________</span><br>
                        <span style="font-size: 10px;">Sign: _________________</span><br>
                        <span style="font-size: 10px;">Date: _________________</span>
                    </div>
    ...
    <div style="margin-top: 20px; padding-top: 15px; border-top: 2px solid #e9ecef; page-break-inside: avoid;">
