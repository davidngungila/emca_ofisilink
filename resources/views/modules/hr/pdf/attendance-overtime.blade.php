...
<head>
    ...
    <style>
        ...
        .overtime-hours { font-weight: bold; color: #940000; }
    </style>
</head>
<body>
    @php
    ...
    <main>
        ...
        <div class="summary-box">
            ...
            <div style="text-align: center;">
                <div class="stat-card">
                    <strong>{{ $reportData['summary']['total_overtime_records'] }}</strong>
                    <span>Overtime Records</span>
                </div>
                <div class="stat-card">
                    <strong>{{ $reportData['summary']['total_overtime_hours'] }}</strong>
                    <span>Total Overtime Hours</span>
                </div>
                <div class="stat-card">
                    <strong>{{ $reportData['summary']['unique_employees'] }}</strong>
                    <span>Employees</span>
                </div>
            </div>
        </div>
        ...
        <!-- Summary by Employee -->
        <h2>Overtime Summary by Employee</h2>
        ...
        <table class="bordered-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 12%;" class="text-center">Overtime Days</th>
                    <th style="width: 16%;" class="text-center">Total Hours</th>
                    <th style="width: 17%;" class="text-center">Average Hours</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"><strong>{{ $employee['total_overtime_days'] }}</strong></td>
                    <td class="text-center overtime-hours">{{ $employee['total_overtime_hours'] }}h</td>
                    <td class="text-center">{{ $employee['average_overtime_hours'] }}h</td>
                </tr>
                @endforeach
            </tbody>
        </table>
        @else
        <p style="text-align: center; color: #6c757d; font-style: italic; padding: 20px;">No overtime records for this period.</p>
        @endif

        <!-- Detailed Records -->
        @if($reportData['all_records']->count() > 0)
        <h2>Detailed Overtime Records</h2>
        <table class="bordered-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 10%;" class="text-center">Normal Hours</th>
                    <th style="width: 10%;" class="text-center">Overtime</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">{{ $record['normal_hours'] }}h</td>
                    <td class="text-center overtime-hours">{{ $record['overtime_hours'] }}h</td>
                    <td class="text-center">
                        <span class="status-badge {{ $record['approval_status'] === 'verified' ? 'badge-verified' : 'badge-pending' }}">
