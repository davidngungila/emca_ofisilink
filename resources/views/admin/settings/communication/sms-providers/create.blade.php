...
@section('title', 'Add SMS Provider - Communication Settings')
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        <div>
                            <h3 class="mb-2 text-white fw-bold">
                                <i class="bx bx-message-rounded-dots me-2"></i>Add SMS Provider
                            </h3>
                            <p class="mb-0 text-white-50">Configure a new SMS gateway provider for system notifications</p>
                        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    <input type="password" name="sms_password" id="sms_password" class="form-control" required placeholder="SMS gateway password">
...
function testSmsProvider() {
    ...
    const formData = {
        ...
        sms_password: form.querySelector('input[name="sms_password"]').value,
    ...
    if (!formData.sms_username || !formData.sms_password || !formData.sms_url) {
        Swal.fire({
            icon: 'warning',
...
document.getElementById('smsProviderForm').addEventListener('submit', function(e) {
    ...
    const formData = {
        ...
        sms_password: this.querySelector('input[name="sms_password"]').value,
