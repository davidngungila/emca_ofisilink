...
|
| Simplified routes at /api/ for easier mobile app integration
| Full routes also available at /api/mobile/v1/ for versioning
|
*/

// ============================================================================
// SIMPLIFIED API ROUTES (for mobile app compatibility)
// Routes in api.php are automatically prefixed with /api
// So /auth/login becomes /api/auth/login
// ============================================================================

// Public routes (no authentication required) - Simplified paths
// Authentication
...
// Protected routes (authentication required) - Simplified paths
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/leaves/balance', [LeaveApiController::class, 'balance']); // Must be before /leaves/{id}
    Route::get('/leaves/types', [LeaveApiController::class, 'types']); // Must be before /leaves/{id}
    ...
    // Finance - Refunds
    Route::get('/finance/refunds', [RefundApiController::class, 'index']);
    Route::get('/finance/refunds/my', [RefundApiController::class, 'myRefunds']);
    Route::get('/finance/refunds/{id}', [RefundApiController::class, 'show']);
    Route::post('/finance/refunds', [RefundApiController::class, 'store']);
    Route::post('/finance/refunds/{id}/hod-approve', [RefundApiController::class, 'hodApprove']);
    Route::post('/finance/refunds/{id}/accountant-verify', [RefundApiController::class, 'accountantVerify']);
    Route::post('/finance/refunds/{id}/ceo-approve', [RefundApiController::class, 'ceoApprove']);
    Route::post('/finance/refunds/{id}/mark-paid', [RefundApiController::class, 'markAsPaid']);
    Route::get('/finance/refunds/{id}/attachments/{attachmentId}/download', [RefundApiController::class, 'downloadAttachment']);
    
    // Finance - Accounts Receivable (Invoices)
    Route::get('/finance/invoices', [AccountsReceivableApiController::class, 'index']);
    Route::get('/finance/invoices/pending', [AccountsReceivableApiController::class, 'pending']);
    Route::get('/finance/invoices/{id}', [AccountsReceivableApiController::class, 'show']);
    Route::post('/finance/invoices/{id}/approve', [AccountsReceivableApiController::class, 'approve']);
    Route::post('/finance/invoices/{id}/reject', [AccountsReceivableApiController::class, 'reject']);
...
// ============================================================================
// VERSIONED API ROUTES (mobile/v1) - For backward compatibility
// ============================================================================
